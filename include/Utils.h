...
class Utils {
 ...
 public:
  ...
  static bool postHTTP(char *username, char *password, char *url);
  static bool postHTTPBinaryData(char *username, char *password, char *url, char *batch_file); 
  ...
  static bool _httpGet(char *url);
  static bool checkInfluxDBServer();
